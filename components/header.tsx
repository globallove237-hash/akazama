...
export default function Header() {
  ...
  const contactLink = createWhatsAppLink("Bonjour, je souhaite en savoir plus sur Global Love")
  const startLink = createWhatsAppLink("Je veux commencer sur Global Love")
      ...
      <header className="relative z-20 flex items-center justify-between p-4 md:p-6">
        <div className="flex items-center">
          ...
          >
            ...
            <circle cx="30" cy="25" r="18" fill="none" stroke="currentColor" strokeWidth="1" opacity="0.6" />
            <path d="M12 25 L48 25" stroke="currentColor" strokeWidth="1" opacity="0.6" />
            <path d="M30 7 Q20 25 30 43 Q40 25 30 7" fill="none" stroke="currentColor" strokeWidth="1" opacity="0.6" />
            <text x="65" y="35" className="text-base md:text-lg font-bold fill-current">
              GL
            </text>
          </svg>
          <span className="ml-2 text-white font-semibold text-base md:text-lg">Global Love</span>
        </div>
        ...
        <button onClick={() => setShowMobileMenu(true)} className="md:hidden text-white p-2">
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 max-w-md w-full border border-white/20 mx-4">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-lg md:text-xl font-semibold text-white">À propos de Global Love</h3>
            ...
            <div className="space-y-4 text-white/80 text-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <strong>Rencontres authentiques</strong> - Connectez-vous avec des personnes qui partagent vos valeurs
                </div>
              </div>
              <div className="flex items-center gap-3">
                <Globe className="w-4 h-4 text-blue-400 flex-shrink-0" />
                <div>
                  <strong>Communauté mondiale</strong> - Rencontrez des célibataires du monde entier
                </div>
              </div>
              <div className="flex items-center gap-3">
                <Shield className="w-4 h-4 text-green-400 flex-shrink-0" />
                <div>
                  <strong>Sécurité garantie</strong> - Profils vérifiés et conversations protégées
                </div>
              </div>
              <div className="flex items-center gap-3">
                <Sparkles className="w-4 h-4 text-yellow-400 flex-shrink-0" />
                <div>
                  <strong>Algorithme intelligent</strong> - Des suggestions personnalisées pour vous
                </div>
              </div>
            </div>
