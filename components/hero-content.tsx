...
export default function HeroContent() {
  const startLink = createWhatsAppLink("Bonjour, je veux commencer sur Global Love")
    ...
    <main className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-auto z-20 max-w-lg">
      <div className="text-left">
        ...
        >
          ...
          <span className="text-white/90 text-xs font-light relative z-10">Nouvelle expérience de rencontre</span>
        </div>

        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl md:leading-16 tracking-tight font-light text-white mb-4">
          <span className="font-medium italic instrument">Trouvez</span> l'Amour
          <br />
          <span className="font-light tracking-tight text-white">Authentique</span>
        </h1>

        <p className="text-xs sm:text-sm font-light text-white/70 mb-6 leading-relaxed max-w-md">
          Découvrez des connexions sincères avec Global Love. Notre plateforme vous met en relation avec des
          célibataires compatibles du monde entier, pour des rencontres qui comptent vraiment.
        </p>
